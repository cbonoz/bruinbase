...
# Ver 1.5, Nov. 29th 2015            #
######################################

Final submission comments:
The outputs of our bruinbase code for the sample test cases are recorded in the <final-output.txt>. The difference of our final submission with the previous submissions are explained in the <diff-result.txt>, and detailed diff outputs are recorded in the ./diff/ folder.
...
This part added support for indexing in our database engine.
